-- Insert into vinyls table with updated image_url
INSERT INTO vinyls (
    stock,
    description,
    price,
    ...
    -- The Wall
    (50, 'A classic album by Pink Floyd', 25.99, 'Pink Floyd', 'The Wall', '1979-11-30', false, 1, 1, 3, 1, 'https://i.scdn.co/image/ab67616d0000b2735d48e2f56d691f9a4e4b0bdf', 0, false),
    ...
    -- 25
    (50, 'A modern pop album by Adele', 19.99, 'Adele', '25', '2015-11-20', false, 3, 1, 3, 1, 'https://m.media-amazon.com/images/I/71VcJXBDgEL._UF1000,1000_QL80_.jpg', 0, false),
    ...
    (50, 'A classic rock album by Bob Dylan', 23.99, 'Bob Dylan', 'Highway 61 Revisited', '1965-08-30', false, 1, 1, 3, 1, 'https://i.scdn.co/image/ab67616d0000b27341720ef0ae31e10d39e43ca2', 0, false),
    ...
    -- Wasting Light
    (50, 'A modern rock album by Foo Fighters', 22.99, 'Foo Fighters', 'Wasting Light', '2011-04-12', false, 1, 1, 3, 2, 'https://i.scdn.co/image/ab67616d0000b273cdac19bbaee5cc123edcc26f', 0, false),
    ...
    (50, 'A collection of Luciano Pavarotti''s best', 24.99, 'Luciano Pavarotti', 'The Essential Pavarotti', '1990-10-31', false, 6, 1, 3, 3, 'https://i.scdn.co/image/ab67616d0000b273289f4dc7e7f51d324d07d50b', 0, false),
    ...
    -- It's Not Unusual
    (50, 'A pop album by Tom Jones', 20.99, 'Tom Jones', 'It''s Not Unusual', '1965-01-01', false, 3, 1, 3, 3, 'https://i.scdn.co/image/ab67616d0000b273cfe16d3b440dffb1220328f7', 0, false),
    ...
    -- Abbey Road
    (50, 'A legendary album by The Beatles', 27.99, 'The Beatles', 'Abbey Road', '1969-09-26', false, 1, 1, 3, 4, 'https://i.scdn.co/image/ab67616d0000b273dc30583ba717007b00cceb25', 0, false),
    ...
    -- OK Computer
    (50, 'A groundbreaking alternative album by Radiohead', 25.99, 'Radiohead', 'OK Computer', '1997-05-21', false, 1, 1, 3, 4, 'https://i.scdn.co/image/ab67616d0000b273c8b444df094279e70d0ed856', 0, false),
    ...
    (50, 'A classic metal album by Iron Maiden', 26.99, 'Iron Maiden', 'The Number of the Beast', '1982-03-22', false, 8, 1, 3, 4, 'https://i.scdn.co/image/ab67616d0000b2730910e39b1092e8ec44626aa3', 0, false),
    ...
    -- Maiden Voyage
    (50, 'A classic jazz album by Herbie Hancock', 23.99, 'Herbie Hancock', 'Maiden Voyage', '1965-05-17', false, 2, 1, 3, 5, 'https://i.scdn.co/image/ab67616d0000b27344e77f19a8f35955870d4907', 0, false),
    ...
    -- Song for My Father
    (50, 'A jazz classic by Horace Silver', 19.99, 'Horace Silver', 'Song for My Father', '1965-01-01', false, 2, 1, 3, 5, 'https://i.scdn.co/image/ab67616d0000b2739453839d1e3569bdebc9ffab', 0, false),
    ...
    -- Arrival
    (50, 'A pop album by ABBA', 18.99, 'ABBA', 'Arrival', '1976-10-11', false, 3, 1, 3, 6, 'https://i.scdn.co/image/ab67616d0000b27300a86f72f75086f7fb441899', 0, false),
    ...
    -- Crazy Blues
    (50, 'A blues album by Mamie Smith', 17.99, 'Mamie Smith', 'Crazy Blues', '1920-08-10', false, 7, 1, 3, 7, 'https://i.scdn.co/image/ab67616d0000b273a0a0111739741dc48f57bd82', 0, false),
    ...
    -- Sing, Sing, Sing
    (50, 'A jazz album by Benny Goodman', 19.99, 'Benny Goodman', 'Sing, Sing, Sing', '1937-07-06', false, 2, 1, 3, 8, 'https://i.scdn.co/image/ab67616d0000b273f5776ac73cc0befaa3f32ce0', 0, false),
    ...
    -- Strange Fruit
    (50, 'A jazz album by Billie Holiday', 22.99, 'Billie Holiday', 'Strange Fruit', '1939-04-20', false, 2, 1, 3, 8, 'https://i.scdn.co/image/ab67616d0000b27342eaf8e2d503d28e99ad03a1', 0, false),
    ...
    -- Californication
    (50, 'A rock album by Red Hot Chili Peppers', 27.99, 'Red Hot Chili Peppers', 'Californication', '1999-06-08', false, 1, 1, 3, 9, 'https://i.scdn.co/image/ab67616d0000b273a9249ebb15ca7a5b75f16a90', 0, false),
    ...
    -- 1989
    (50, 'A pop album by Taylor Swift', 24.99, 'Taylor Swift', '1989', '2014-10-27', false, 3, 1, 3, 10, 'https://i.scdn.co/image/ab67616d0000b273dc2bacae1dca83d26e2b1949', 0, false),
    ...
    -- Chromatica
    (50, 'A pop album by Lady Gaga', 23.99, 'Lady Gaga', 'Chromatica', '2020-05-29', false, 3, 1, 3, 10, 'https://i.scdn.co/image/ab67616d0000b2736040effba89b9b00a6f6743a', 0, false);

    -- Insert into discs table with the correct tracklists, using subqueries to get vinyl_id
