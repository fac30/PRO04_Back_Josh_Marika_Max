    ...
    paths: {
      ...
      "/login": {
        post: {
          ...
          description:
            "Authenticates a user and starts a session. Returns customer data excluding password_hash.",
          requestBody: {
            required: true,
            content: {
              "application/json": {
      ...
      "/shipping-options/{id}": {
        get: {
          ...
          description:
            "Fetches shipping options from the shipping_options table.",
          parameters: [
            {
              name: "id",
              in: "path",
          ...
          responses: {
            200: {
              description:
                "A list of shipping options or a single option if ID is provided.",
              content: {
                "application/json": {
                  schema: {
                    type: "array",
      ...
      "/transactions": {
        get: {
          ...
          description:
            "Fetches all transactions for a given customer ID and optional status.",
          parameters: [
            {
              name: "customer_id",
              in: "query",
      ...
      "/status/{status}/{customer_id}": {
        get: {
          ...
          description:
            "Fetches transactions based on status and optional customer ID.",
          parameters: [
            {
              name: "status",
              in: "path",
